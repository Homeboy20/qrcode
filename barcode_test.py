...
print("Testing barcode generation endpoint...")
URL = "http://127.0.0.1:5000/generate_barcode"
payload = {
    "data": "123456789012",
    "barcode_type": "code128",  # Using Code128 format
    "is_dynamic": False
}
        ...
        if "image_url" in data:
            ...
            try:
                ...
                if img_response.status_code == 200:
                    ...
                    print("Saving image to barcode_test.png...")
                    with open("barcode_test.png", "wb") as f:
                        f.write(img_response.content)
                    
                    print("\nSuccess! Barcode image saved to barcode_test.png")
                else:
